...
# 7. Output Filter Capacitor C3 (Moved slightly down to y=19.2 to give space)
...
# BAT_OUT
add_track("BAT_OUT", pcbnew.F_Cu, W_BAT, CX+2.7, 13.5+1.905, CX, 19.2-0.95)
add_track("BAT_OUT", pcbnew.F_Cu, W_BAT, CX, 19.2-0.95, CX-1.0, 26.6)
add_track("BAT_OUT", pcbnew.F_Cu, W_SIG, CX, 19.2-0.95, 2.2, 21.0-0.95)
...
# 1. Main Header (Placed cleanly between USB-C and TP4056)
...
# 3. Input Capacitors (Placed to the left of footprints, perfectly visible)
add_silk_text("C1", 0.9, 11.2, size=0.45, thickness=0.11)
add_silk_text("C2", 0.9, 13.8, size=0.45, thickness=0.11)

# 4. RPROG (Placed to the left of footprint)
add_silk_text("R3", 0.9, 16.8, size=0.45, thickness=0.11)

# 5. IC TP4056 Label (Placed in open space above IC)
add_silk_text("U1", CX, 10.4, size=0.5, thickness=0.11)

# 6. LED Section (Placed in open space to the left of LEDs)
add_silk_text("R4", 17.1, 11.2, size=0.45, thickness=0.11)
add_silk_text("D1:CHRG", 11.4, 12.8, size=0.42, thickness=0.1)

add_silk_text("R5", 17.1, 16.2, size=0.45, thickness=0.11)
add_silk_text("D2:FULL", 11.4, 16.8, size=0.42, thickness=0.1)

# 7. Output Filter Capacitor (Placed to the right in open space)
add_silk_text("C3", 11.0, 19.2, size=0.45, thickness=0.11)

# 8. Protection Section (Placed clearly in non-overlapping zones)
add_silk_text("R6", 0.9, 21.0, size=0.42, thickness=0.1)
add_silk_text("C4", 0.9, 23.8, size=0.42, thickness=0.1)
...
print("PCB V17 Generated Cleanly!")
