...
# 5. IC TP4056 Label
add_silk_text("U1", CX, 10.8, size=0.5, thickness=0.11)

# 6. LED Section
add_silk_text("R4", 15.6, 9.8, size=0.45)
add_silk_text("D1", 12.6, 13.6, size=0.45, thickness=0.11)

add_silk_text("R5", 15.6, 15.0, size=0.45)
add_silk_text("D2", 12.6, 18.6, size=0.45, thickness=0.11)
...
add_silk_text("U2", 5.2, 20.6, size=0.45, thickness=0.11)
add_silk_text("R7", 5.2, 26.6, size=0.42)
add_silk_text("Q1", 13.0, 20.8, size=0.45, thickness=0.11)
