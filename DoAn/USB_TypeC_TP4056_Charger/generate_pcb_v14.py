...
set_3d(fps["D1"], "/usr/share/kicad/3dmodels/LED_SMD.3dshapes/LED_0805_2012Metric.step")
...
set_3d(fps["D2"], "/usr/share/kicad/3dmodels/LED_SMD.3dshapes/LED_0805_2012Metric.step")
...
# 6. LED Section - Clear Designators & Function
add_silk_text("R4", 15.6, 9.8, size=0.45)
add_silk_text("D1:CHRG (RED)", 11.5, 13.6, size=0.45)

add_silk_text("R5", 15.6, 15.0, size=0.45)
add_silk_text("D2:FULL (GRN)", 11.5, 18.6, size=0.45)
...
print("PCB V14 Final with 3D LED models!")
