...
# 6. LED Section
add_silk_text("R4", 15.8, 10.0, size=0.45)
add_silk_text("D1:CHRG", 13.0, 13.6, size=0.45)

add_silk_text("R5", 15.8, 15.0, size=0.45)
add_silk_text("D2:FULL", 13.0, 18.6, size=0.45)
...
add_silk_text("U2:DW01A", 5.2, 21.0, size=0.45)
add_silk_text("R7", 5.2, 26.6, size=0.42)
add_silk_text("Q1:FS8205A", 13.0, 21.2, size=0.45)
...
add_silk_text("TP4056 USB-C CHARGER", CX, 9.0, pcbnew.B_SilkS, size=0.7, thickness=0.14)
add_silk_text("MSSV: 23207124", CX, 13.5, pcbnew.B_SilkS, size=0.8, thickness=0.15)
add_silk_text("LE NGOC TUONG", CX, 17.0, pcbnew.B_SilkS, size=0.8, thickness=0.15)
add_silk_text("HCMUS - 2026", CX, 21.0, pcbnew.B_SilkS, size=0.6, thickness=0.12)

pcbnew.SaveBoard("/mnt/Windows/HK3-25-26/KhoaHe_PCB/DoAn/USB_TypeC_TP4056_Charger/USB_TypeC_TP4056_Charger.kicad_pcb", board)
print("PCB V12 Complete with all Designator labels!")
