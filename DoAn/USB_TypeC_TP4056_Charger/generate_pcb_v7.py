...
# 1. J1: USB-C Connector (Rotated 180 deg so mouth points OUT at top Y=0)
# Receptacle mouth reaches Y=-0.5mm, mounting shield pins inside board, SMT pins at Y=4.8mm
fps["J1"] = add_fp("J1", "USB-C", FP_LIB, "USB_C_Receptacle_HRO_TYPE-C-31-M-12", CX, 4.2, 180)

# Attach accurate 3D model properly aligned with mouth at top edge
...
# Routing - with J1 rotated 180, pins are at Y = 4.2 + 4.0 = 8.2mm, facing down!
...
# 2. CC1 & CC2 Pull-downs (Connected directly to R1/R2)
