...
# Protection Section - Clear of components
add_silk_text("PROT", CX, 21.0, size=0.5)

# Battery Output Pads
add_silk_text("B+", 5.8, 27.8, size=0.7)
add_silk_text("B-", 12.2, 27.8, size=0.7)

# Bottom Layer (Mã số SV, Tên Đồ Án) - Mirrored is True for bottom silkscreen readability
add_silk_text("TP4056 USB-C CHARGER", CX, 9.0, pcbnew.B_SilkS, size=0.7)
add_silk_text("MSSV: 23207124", CX, 13.5, pcbnew.B_SilkS, size=0.8)
add_silk_text("LE NGOC TUONG", CX, 17.0, pcbnew.B_SilkS, size=0.8)
add_silk_text("HCMUT - 2026", CX, 21.0, pcbnew.B_SilkS, size=0.6)

pcbnew.SaveBoard("/mnt/Windows/HK3-25-26/KhoaHe_PCB/DoAn/USB_TypeC_TP4056_Charger/USB_TypeC_TP4056_Charger.kicad_pcb", board)
print("PCB V10 Finalized!")
