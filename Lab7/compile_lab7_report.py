...
lab_dir = "/mnt/Windows/HK3-25-26/KhoaHe_PCB/Lab7"
md_path = os.path.join(lab_dir, "BaoCao_Lab07.md")
html_path = os.path.join(lab_dir, "BaoCao_Lab07.html")
pdf_path = os.path.join(lab_dir, "BaoCao_Lab07_KiCad.pdf")
...
<head>
<meta charset="UTF-8">
<title>Báo cáo Lab 07 - KiCad DRC</title>
</head>
<body>
{html_body}
</body>
